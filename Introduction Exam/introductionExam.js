...
if (!selectedClass || !validClasses.includes(selectedClass)) {
  ...
  allSubjects = ['Mathematics', 'English', 'Basic Science', 'Basic tech', 'Business studies', 'Agric Science', 'French', 'Home Economics', 'History', 'Physical and health Education', 'National value', 'CCA Art', 'CCA Drama', 'CCA Music', 'Christian Religious studies', 'Yoruba', 'Igbo', 'Computer', 'Cisco', 'Guidance and Councelling'];
}
...
async function validateAndStartExam() {
    ...
    try {
        ...
        setTimeout(() => {
            const examUrl = `./SubjectToBedone${selectedClass}/${subject}.html?class=${selectedClass}&student=${student.id}`;
